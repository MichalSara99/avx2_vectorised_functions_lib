...
tan_avx2_macro_ps			macro
							...
							endm
;;										ecx,			edx
;;		extern "C" bool tan_avx2_ps(float const* x, float* out,int n);
tan_avx2_ps@@12				proc near	
								n_arg		textequ		<[ebp + 8]>
							push ebp
							mov ebp,esp
							push ebx
				...
				@@:			vmovaps ymm0,ymmword ptr [ecx]					;; x = xmm0
							;; ======
							tan_avx2_macro_ps
							;; ======
...
;;											ecx,		edx
;;			extern "C" bool cot_avx2_ps(float const* x,float* out, int n);
cot_avx2_ps@@12				proc near
								n_arg		textequ		<[ebp + 8]>
							push ebp
							mov ebp,esp
							push ebx
...
tan_avx2_macro_pd			macro
							...
							endm
;;										ecx,		edx
;;		extern "C" bool tan_avx2_pd(double const* x,double* out, int n);
tan_avx2_pd@@12				proc near
								n_arg		textequ		<[ebp + 8]>
							push ebp
							mov ebp,esp
							push ebx
				...
				@@:			vmovapd ymm0,ymmword ptr [ecx]					;; x = xmm0
							;; =======
							tan_avx2_macro_pd
							;; =======
...
cot_avx2_macro_pd			macro
							...
							endm
;;										ecx,			edx
;;		extern "C" bool cot_avx2_pd(double const* x,double* out, int n);
cot_avx2_pd@@12				proc near	
								n_arg		textequ		<[ebp + 8]>
							push ebp
							mov ebp,esp
							push ebx

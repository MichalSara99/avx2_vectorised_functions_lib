include asm_x86_incs/tanh_funcs.inc
...
tanh_avx2_macro_ps			macro
							...
							endm
;;								ecx,		edx
;; extern "C" tanh_avx2_ps(float const *in,float *out,int size);
tanh_avx2_ps@@12			proc near
								n_arg		textequ		<[ebp + 8]>
							push ebp
							mov ebp,esp
							push ebx
...
tanh_avx2_macro_pd			macro
							...
							endm
;;								ecx,		edx
;; extern "C" tanh_avx2_pd(double const *in,double *out,int size);
tanh_avx2_pd@@12			proc near
								n_arg		textequ		<[ebp + 8]>
							push ebp
							mov ebp,esp
							push ebx
